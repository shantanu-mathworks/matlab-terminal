...
- **Open an issue:** Start by [creating an issue](https://github.com/prabhakk-mw/matlab-terminal/issues). That will start a conversation with the maintainer. When you are creating a bug report, please include as many details as possible. Please remember that other people do not have your background or understanding of the issue; make sure you are clear and complete in your description.
